...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="../images/logo_denpasar.png">
    <title>Login | SIGKELDENSEL</title>
            ...
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                  <?php
                  	if(isset($_GET['pesan'])){
                  		if($_GET['pesan'] == "gagal"){
                  			echo "<span style='color: white'>Login gagal! username atau password salah atau akun di nonaktifkan!</span>";
                  		}else if($_GET['pesan'] == "logout"){
                  			echo "<span style='color: white'>Anda telah berhasil logout</span>";
                  		}else if($_GET['pesan'] == "belum_login"){
                  			echo "<span style='color: white'>Anda harus login untuk mengakses halaman admin</span>";
                  		}
                  	}
                  ?>
